  ...
  return (
    <div className="flex h-[900px] flex-col items-center justify-center gap-10 bg-cover bg-no-repeat">
      <div className="relative px-10 py-6">
        <h1 className="from-white-800 rounded-3xl bg-opacity-50 bg-gradient-to-br to-gray-900 px-10 py-6 text-center text-5xl font-bold text-gray-100 shadow-lg backdrop-blur-lg">
          Upcoming Events
        </h1>
      </div>
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    <div className="relative size-96">
                      <Image
                        src={event.bannerImage ?? "/assets/avin/bg-image.jpeg"}
                        alt={event.name}
